 ...
 *
 * Canonical source for brand presets shared across the monorepo.
 * All apps (Vite SPA, Hono worker, Astro site) import from this package.
 *
 * ## Adding a new preset
...
export function getRadiusValue(key: string): string {
  return radiusValues[key] ?? radiusValues.rounded
}
...
export { darken, fontFamilies, radiusValues }
