      ...
      fields: [
        {
          ...
          defaultValue: 'warm',
          options: [
            { label: 'Warm — terra cotta, serif, rounded', value: 'warm' },
            { label: 'Calm — teal, humanist sans, soft', value: 'calm' },
            { label: 'Bold — deep red, modern sans, sharp', value: 'bold' },
            { label: 'Classic — navy blue, serif, soft', value: 'classic' },
            { label: 'Modern — slate, sans, sharp', value: 'modern' },
            { label: 'Forest — deep green, humanist, soft', value: 'forest' },
            { label: 'Royal — deep purple, serif, rounded', value: 'royal' },
          ],
        },
