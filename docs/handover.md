...
Working source is ahead of published v0.26.0. Migration 0009 adds independent
participation versions and must be applied before the updated Worker. Existing
...
`test/participation.spec.ts`. For ownership, management trust, or authentication
