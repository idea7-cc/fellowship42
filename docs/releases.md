...
`portable-restore-conformance.v1.json` is generated by the public `f42ctl`
runner through real export, verification, planning, and isolated-restore code.
It covers tamper rejection, new/empty destination enforcement, D1/R2 restore,
credential rotation, portable identity and runtime verification, cutover
